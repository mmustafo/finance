    ...
    <section className={style.login}>
      <div className={`${style.container} container`}>
        <div className={style.login__left}>
          <img src="../public/image/logo-large.svg" alt="logo" width={200} />
          <h3>keep track of money anfdsavefor your future</h3>
          <p>
        ...
        <div className={style.login__right}>
          ...
          <form onSubmit={handleSubmit} className={style.login__from}> 
            ...
            <button className={`${style.login__button} btn`}>Login</button>
